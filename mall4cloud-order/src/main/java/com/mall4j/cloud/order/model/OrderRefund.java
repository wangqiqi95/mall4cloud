...
public class OrderRefund extends BaseModel implements Serializable {
     ...
     * 退款记录ID
     */
    @DistributedId(DistributedIdKey.MALL4CLOUD_REFUND)
    ...
    public void setOfflineRefund(Integer offlineRefund) {
    ...
    public Long getComplaintOrderId() {
        return complaintOrderId;
    }

    public void setComplaintOrderId(Long complaintOrderId) {
        this.complaintOrderId = complaintOrderId;
    }

    public Long getComplaintUserIsRead() {
        return complaintUserIsRead;
    }

    public void setComplaintUserIsRead(Long complaintUserIsRead) {
        this.complaintUserIsRead = complaintUserIsRead;
    }

    public Long getComplaintPlatformIsRead() {
        return complaintPlatformIsRead;
    }

    public void setComplaintPlatformIsRead(Long complaintPlatformIsRead) {
        this.complaintPlatformIsRead = complaintPlatformIsRead;
    }
