...
public class StdResult<T> {
	...
	public StdResult(Integer code, Boolean isSuccess) {
		this.code = code;
		this.isSuccess = isSuccess;
	}

	public StdResult(Integer code, Boolean isSuccess,T data) {
		this.code = code;
		this.isSuccess = isSuccess;
		this.data = data;
	}

	public StdResult(Integer code, Boolean isSuccess, String errorMsg) {
		this.code = code;
		this.isSuccess = isSuccess;
	...
	public static StdResult success() {
		return new StdResult(succCode, true);
	}

	public static <T> StdResult<T> success(T data) {
		return new StdResult(succCode, true,data);
	}

	public static StdResult fail(String errorMsg) {
		return new StdResult(errorCode, false, errorMsg);
	}
