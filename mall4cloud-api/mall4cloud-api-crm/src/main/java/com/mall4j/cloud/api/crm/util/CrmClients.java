...
import com.mall4j.cloud.api.crm.config.CrmParamsConfig;
...
public class CrmClients {
	...
	static CrmParamsConfig crmParamsCopy;
...
//					System.currentTimeMillis() - start);
	...
	public static void setContext(ApplicationContext applicationContext) {
		crmParamsCopy = applicationContext.getBean(CrmParamsConfig.class);
	}
}
