...
public interface UserAddrFeignClient {
     ...
     * @return 用户地址信息
     */
    @GetMapping(value = FeignInsideAuthConfig.FEIGN_INSIDE_URL_PREFIX + "/insider/userAddr/getStaffUserAddrByAddrId")
    ServerResponseEntity<UserAddrVO> getStaffUserAddrByAddrId(@RequestParam("addrId") Long addrId, @RequestParam("userId") Long userId);
