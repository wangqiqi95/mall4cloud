...
/**
 * @author Peter_Tan
 * @Description: 调用企业微信获取群发成员发送任务列表接口
 * @date : 2023-03-20
 * @Version: 1.0
 */
@Data
public class WxCpGroupMsgTaskVO implements Serializable {
    ...
    private List<WxCpGroupMsgTaskVO.ExternalContactGroupMsgTaskInfo> taskList;
    ...
    public static class ExternalContactGroupMsgTaskInfo implements Serializable {
        ...
        @ApiModelProperty("0-未发送 1-已发送 2-因客户不是好友导致发送失败 3-因客户已经收到其他群发消息导致发送失败")
