...
public class RoleController {
    ...
    public ServerResponseEntity<PageVO<RoleVO>> page(@Valid PageDTO pageDTO, String roleName) {
        UserInfoInTokenBO userInfoInTokenBO = AuthUserContext.get();
        PageVO<RoleVO> rolePage = roleService.page(pageDTO, userInfoInTokenBO.getSysType(), userInfoInTokenBO.getTenantId(), roleName);
