...
public class SpuCodeReadExcelListener extends AnalysisEventListener<SpuCodeReadExcelVO> {
    ...
    private SpuCodeReadExcelVO skuPriceFeeExcelVO;
    ...
    public SpuCodeReadExcelListener() {
    }
    ...
    public SpuCodeReadExcelListener(SpuExcelService spuExcelService, Map<Integer, List<String>> errorMap) {
    ...
    @Override
    public void invoke(SpuCodeReadExcelVO skuPriceFeeExcelVO, AnalysisContext analysisContext) {

        list.add(skuPriceFeeExcelVO.getSpuCode());
    }
