...
public class PrincipalUtil {
	...
	public static final String UP_TO_ONE_DECIMAL = "^(-)?[1-9]\\d*$|^(-)?[1-9]\\d*\\.\\d?$|^(-)?0\\.\\d?$";
	...
	public static boolean isUserName(String value) {
		//更换为手机号验证
		return isMatching(MOBILE_REGEXP, value) || true;
	}
	...
	public static boolean isMaximumOfTwoDecimal(String value) {
		return isMatching(UP_TO_TWO_DECIMAL,value);
	}
	 ...
	 * @return 匹配结果
	 */
	public static boolean isMaximumOfOneDecimal(String value) {
		return isMatching(UP_TO_ONE_DECIMAL,value);
	}
	...
	public static boolean isVerificationCode(String value) {
		return isMatching(VERIFICATION_CODE,value);
	}
