package com.mall4j.cloud.common.limiter.interceptor;

import com.mall4j.cloud.common.exception.RateLimitException;
import com.mall4j.cloud.common.limiter.anns.RateLimit;
import com.mall4j.cloud.common.limiter.support.HttpContentHelper;
...
public class RateLimitInterceptor implements ApplicationContextAware {
    ...
    @Around("execution(public * *(..)) && @annotation(com.mall4j.cloud.common.limiter.anns.RateLimit)")
