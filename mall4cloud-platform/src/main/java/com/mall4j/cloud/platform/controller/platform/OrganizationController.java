...
public class OrganizationController {
    ...
    @GetMapping("/tree")
    @ApiOperation(value = "查询组织节点-树形结构", notes = "查询所有组织节点按所属结构分配")
    public ServerResponseEntity<List<OrganizationVO>> tree() {
        List<OrganizationVO> organizations =  organizationService.tree();
        return ServerResponseEntity.success(organizations);
    }
