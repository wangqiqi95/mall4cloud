...
//        sysConfigMapper.deleteBatch(ids);
    ...
    public void saveOrUpdateSysConfig(SysConfig sysConfig) {
        ...
        RedisUtil.deleteBatchKeys(ConfigCacheNames.SYS_CONFIG+"*");
        RedisUtil.deleteBatchKeys(ConfigCacheNames.SYS_CONFIG_VALUE+"*");
        RedisUtil.del(ConfigCacheNames.SYS_CONFIG+"*");
        RedisUtil.del(ConfigCacheNames.SYS_CONFIG_VALUE+"*");
    }
