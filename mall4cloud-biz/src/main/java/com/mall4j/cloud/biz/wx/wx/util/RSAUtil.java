...
public class RSAUtil {
	 ...
	 * @throws Exception
	 */
	public static byte[] decryptByPriKey(byte[] data, byte[] priKey,String type) throws Exception {
		if("1".equals(type)){
	 ...
	 * @throws Exception
	 */
	public static String decryptByPriKey(String data, String privateKey,String type) throws Exception {
		byte[] priKey = RSAUtil.decodeBase64(privateKey);
		byte[] design = decryptByPriKey(Base64.decodeBase64(data), priKey,type);
		return new String(design);
	}
