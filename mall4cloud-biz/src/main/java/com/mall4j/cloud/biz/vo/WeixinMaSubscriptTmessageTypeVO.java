 ...
 */
@Data
public class WeixinMaSubscriptTmessageTypeVO extends BaseVO{
	...
	@ApiModelProperty("业务类型：1会员业务 2优惠券业务 3订单业务 4退单业务 5线下活动  " +
			"6积分商城 7每日签到 8直播通知 9微客审核 20问卷调查 ")
	private Integer businessType;

	@ApiModelProperty("100.会员生日到期提醒 200.优惠券到期提醒 201.优惠券到账提醒 " +
			"300.积分变更提醒 301.等级到期提醒  400.订单发货提醒  401.订单签收提醒 " +
			"500.退单审核结果提醒 501.退单完成提醒 600.活动上新提醒 601.活动开始提醒")
	...
	private List<WeixinMaSubscriptTmessageValueVO> contentValues;
}
