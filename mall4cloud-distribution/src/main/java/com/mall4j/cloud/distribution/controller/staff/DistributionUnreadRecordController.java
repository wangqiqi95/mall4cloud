 ...
 */
@RestController("staffDistributionUnreadRecordController")
@RequestMapping("/s/distribution_unread_record")
@Api(tags = "导购小程序-分销推广-用户未读信息")
public class DistributionUnreadRecordController {
    ...
    public ServerResponseEntity<DistributionUnreadRecord> getDistributionUnreadRecord() {
        return ServerResponseEntity.success(distributionUnreadRecordService.getByUser(1, AuthUserContext.get().getUserId()));
    }
}
