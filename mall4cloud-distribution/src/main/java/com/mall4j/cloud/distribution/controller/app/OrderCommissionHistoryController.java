 ...
 */
@RestController("appOrderCommissionHistoryController")
@RequestMapping("/order_commission_history")
@Api(tags = "威客小程序-历史提现订单")
public class OrderCommissionHistoryController {
    ...
    public ServerResponseEntity<PageVO<OrderCommissionHistory>> page(@Valid PageDTO pageDTO) {
        ...
        orderCommissionHistoryDTO.setIdentityType(2);
