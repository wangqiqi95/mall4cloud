 ...
 */
@RestController("staffDistributionBuyRecordController")
@RequestMapping("/s/distribution_buy_record")
@Api(tags = "导购小程序-导购端-分销推广-下单记录")
public class DistributionBuyRecordController {
    ...
    public ServerResponseEntity<DistributionPromotionStatVO> stat() {
        DistributionPromotionStatVO distributionPromotionStatVO = distributionBuyRecordService.stat(1,
