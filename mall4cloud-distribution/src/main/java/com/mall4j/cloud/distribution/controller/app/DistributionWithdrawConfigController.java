 ...
 */
@RestController("appDistributionWithdrawConfigController")
@RequestMapping("/distribution_withdraw_config")
...
public class DistributionWithdrawConfigController {
    ...
    public ServerResponseEntity<DistributionWithdrawConfig> getConfig() {
        return ServerResponseEntity.success(distributionWithdrawConfigService.getByIdentityType(2));
    }
}
