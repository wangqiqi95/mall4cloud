 ...
 */
@RestController("platformDistributionSubjectStoreController")
@RequestMapping("/p/distribution_subject_store")
...
public class DistributionSubjectStoreController {
    ...
    @GetMapping("/listMomentsStoreBySubjectId")
    @ApiOperation(value = "获取分销推广-专题门店", notes = "根据专题id获取分销推广-专题门店")
    public ServerResponseEntity<List<DistributionSubjectStore>> listMomentsStoreBySubjectId(@RequestParam Long id) {
        return ServerResponseEntity.success(distributionSubjectStoreService.listBySubjectId(id));
    }
}
