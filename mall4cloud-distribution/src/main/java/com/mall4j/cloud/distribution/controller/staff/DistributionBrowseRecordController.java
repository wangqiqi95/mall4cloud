 ...
 */
@RestController("staffDistributionBrowseRecordController")
@RequestMapping("/s/distribution_browse_record")
@Api(tags = "导购小程序-分享推广-浏览记录")
public class DistributionBrowseRecordController {
    ...
    public ServerResponseEntity<DistributionPromotionStatVO> stat() {
        DistributionPromotionStatVO distributionPromotionStatVO = distributionBrowseRecordService.stat(1,
